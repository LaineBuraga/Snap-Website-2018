...
<body class="wrapper">
	...
	<div class="upload uploadVisibility">
		...
		<div id="postButtons">
			<button class="button" id="postCommentButton" onkeydown="postCommentButton(event)" tabindex="2">Comment</button>
			<button class="button" id="pictureBtn" onkeydown="postpictureButton(event)" tabindex="3">Picture</button>
			<button class="button" id="reactButtonPost" onkeydown="postSubmitButton(event)" tabindex="4">Submit</button>
        </div>
